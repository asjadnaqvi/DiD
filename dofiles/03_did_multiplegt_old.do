...
graph export cd_1.png, replace	wid(2000)			
...
did_multiplegt_old Y id t D, robust_dynamic dynamic(10) placebo(10) breps(20) cluster(id)

ereturn list
return list

event_plot e(estimates)#e(variances), default_look graph_opt(xtitle("Periods since the event") ytitle("Average effect") ///
	title("did_multiplegt_old") xlabel(-10(1)10)) stub_lag(Effect_#) stub_lead(Placebo_#) together
graph export did_multiplegt_old.png, replace	wid(2000)		
