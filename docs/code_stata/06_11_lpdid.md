...
| Metric | Value |
| ------ | ----- |
| On-impact effect (`tau0`) | -0.0746 |
| First post period (`tau1`) | 8.5732 |
| Tenth post period (`tau10`) | 85.7819 |
| Pooled pre estimate | -0.1660 (p = 0.5507) |
| Pooled post estimate | 43.0912 (p < 0.001) |

This summary matches the event-study figure: flat pre periods and strongly positive post periods.
