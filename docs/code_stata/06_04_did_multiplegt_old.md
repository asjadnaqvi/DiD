...
This is now a legacy command and should be replaced by the much faster [did_multiplegt_dyn](https://asjadnaqvi.github.io/DiD/docs/code_stata/06_16_did_multiplegt_dyn/).
