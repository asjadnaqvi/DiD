...
| Metric | Value |
| ------ | ----- |
| Event-study sample | 1,800 |
| On-impact effect (`L_0`) | 0.0792 |
| First post period (`L_1`) | 8.6194 |
| Tenth post period (`L_10`) | 85.8252 |
| Example lead (`F_2`) | 0.2253 |

The shape mirrors other estimators in this dataset: near-zero pre period, then increasing post effects.
