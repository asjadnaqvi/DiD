...
- 基于：Dube等人（2023）。[双重差分法的局部投影方法](https://www.nber.org/papers/w31184)
- 程序版本（如有）：-
- 最后检查：2024年11月
...
ssc install reghdfe, replace  // 依赖包
ssc install boottest, replace  // 依赖包
ssc install egenmore, replace  // 依赖包
```
