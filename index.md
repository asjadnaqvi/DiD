...
I maintain the [Stata code](https://asjadnaqvi.github.io/DiD/docs/code_stata) while [@grantmcdermott](https://github.com/grantmcdermott) has been super amazing in maintaining the [R code](https://asjadnaqvi.github.io/DiD/docs/code_r). Please reach out if you can help contribute information for *Python*, *Julia*, or other languages.
